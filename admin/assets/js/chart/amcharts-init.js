(function () {
    ...
    const amCharts = (function () {
      
		const amChartsColumnRotated = function () {
			am5.ready(function () {
				// Set root to correct container
				var root = am5.Root.new("amChartsColumnRotated");
		...
		const amChartsLineDataLabels = function () {
			am5.ready(function() {
				var root = am5.Root.new("amChartsLineDataLabels");
		...
		const amChartsStockChart = function () {
			am5.ready(function() {

				// Create root element
				// -------------------------------------------------------------------------------
				// https://www.amcharts.com/docs/v5/getting-started/#Root_element
				var root = am5.Root.new("amChartsStockChart");
		...
		const amChartsPieChart = function () {
			am5.ready(function() {

				// Create root element
				// https://www.amcharts.com/docs/v5/getting-started/#Root_element
				var root = am5.Root.new("amChartsPieChart");
		...
		const amChartsFunnelChart = function () {
			am5.ready(function() {
			
				// Create root element
				// https://www.amcharts.com/docs/v5/getting-started/#Root_element
				var root = am5.Root.new("amChartsFunnelChart");
		...
		return {
			init: function () {
				amChartsColumnRotated();
				amChartsLineDataLabels();
				amChartsStockChart();
				amChartsPieChart();
				amChartsFunnelChart();
			}
