(function($) {
	...
	$(".select2-programmatic-enable").select2();
	$(".select2-programmatic-disable").select2();
	$("#select2-programmatic-enable").on("click", function () {
		$(".select2-programmatic-enable").prop("disabled", false);
		$(".select2-programmatic-disable").prop("disabled", false);
	});
	$("#select2-programmatic-disable").on("click", function () {
		$(".select2-programmatic-enable").prop("disabled", true);
		$(".select2-programmatic-disable").prop("disabled", true);
	});
